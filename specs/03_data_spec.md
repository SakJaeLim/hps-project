...
- LiveProvider: 비식별 TOS/AIS → 캐노니컬 매핑(실데이터 도착 시)
...
## 실데이터 원천
운영사 제공 정형(BAPLIE/COPRAR/MOVINS/Yard Inventory/Gate/Equipment/AIS/Bay Plan/Call History) + 비정형(SOP/Safety/IMO/ISPS/SOLAS/Accident) 매핑은 **specs/06_data_sources.md** 참조.
